(function($) {
 ...
 /* Engaged Users */
  var engagedUsersCanvas = document.getElementById('engaged-users');
  if (engagedUsersCanvas) {
    var engagedUsersCtx = engagedUsersCanvas.getContext('2d');
