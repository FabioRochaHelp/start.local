...
<head>
    ...
    <!-- Set base path so that 'assets/' resolves to /landpage/assets/ -->
    <base href="{{ asset('landpage/') }}/">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="menu-item menu-item-has-children">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="menu-item">
                                    <a href="service-details-left-sidebar.html">Service Details Left<span
                                            class="new-badge">New</span></a>
                                </li>
                                <li class="menu-item">
                        ...
                        <li class="menu-item menu-item-has-children">
                            ...
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a href="shop-left-sidebar.html">Shop Left Sidebar<span
                                            class="new-badge">New</span></a>
                                </li>
                                <li class="menu-item">
                                    <a href="shop-right-sidebar.html">Shop Right Sidebar<span
                                            class="new-badge">New</span></a>
                                </li>
                                <li class="menu-item">
                                ...
                                <li class="menu-item">
                                    <a href="product-details.html">Product Details<span
                                            class="new-badge">New</span></a>
                                </li>
                                <li class="menu-item">
                        ...
                        <li class="menu-item menu-item-has-children">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="menu-item">
                                    <a href="contact-us-style-2.html">Contact Style 2<span
                                            class="new-badge">New</span></a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <div class="sigma_header-controls style-2">
                        <ul class="sigma_header-controls-inner">
                            <li class="search-trigger header-controls-item d-none d-sm-block">
                                <a class="sigma_header-control-search bg-transparent border-0" title="Search"
                                    href="#">
                                    <i class="far fa-search"></i>
                                </a>
                            </li>
                            <li class="cart-trigger header-controls-item d-none d-sm-block ms-0">
                                <a class="sigma_header-control-cart bg-transparent border-0" title="Your Cart"
                                    href="cart.html">
    ...
    <div class="sigma_banner style-8">
        <div class="sigma_banner-slider">
            <div class="banner-slider-inner bg-center bg-cover secondary-overlay"
                style="background-image: url('assets/img/home-1/1920x1280.jpg');">
            ...
            <div class="banner-slider-inner bg-center bg-cover secondary-overlay"
                style="background-image: url('assets/img/home-1/1920x1280-1.jpg');">
                <div class="sigma_banner-text text-center">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                    ...
                    <div class="row g-0">
                        <div class="col-lg-6">
                            <div class="form-group with-label">
                                ...
                                <input type="text" class="topic-field" name="fname"
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="location-field" name="location"
    ...
    <div class="section secondary-overlay">
        ...
        <div class="container">
                ...
                <div class="col-lg-5 order-2 order-lg-1">
                    <div class="sigma_about style-21">
                        ...
                        <div class="sigma_about-content">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. It is a long established fact
                                that a reader will be Lorem ipsum dolor sit amet consectetur.</p>
            ...
            <div class="sigma_counter-wrapper margin-negative bg-primary-1 style-5"
                style="background-image: url(assets/img/pattern-2.png)">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-6">
            ...
            <div class="sigma_service-slider">
                <div class="sigma_service style-17">
                    ...
                    <div class="sigma_service-body">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit, sed do eiusmod Lorem ipsum dolor
                            sit.</p>
    ...
    <div class="section">
        <div class="container">
            <div class="row align-items-center mb-5">
                ...
                <div class="col-lg-4">
                    <p class="mb-0">Donec rutrum congue leo eget malesuada. Nulla porttitor accumsan tincidunt.
