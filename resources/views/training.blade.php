                ...
                <div class="col-xl-4 col-md-12">
                    ...
                    <div class="ms-card ms-widget ms-profile-widget ms-card-fh br-0">
                        <div class="ms-card-img">
                            <img src="/images/gallery-4-760x260.jpg" alt="card_img">
                        </div>
                        <img src="/images/doctor-1.jpg" class="ms-img-large ms-img-round ms-user-img" alt="people">
                        ...
                        <div class="ms-panel-body p-0">
                            <ul class="ms-followers ms-list ms-scrollable">
                                <li class="ms-list-item media">
                                    <img src="/images/doctor-1.jpg" class="ms-img-small ms-img-round" alt="people">
                                ...
                                <li class="ms-list-item media">
                                    <img src="/images/doctor-2.jpg" class="ms-img-small ms-img-round" alt="people">
                                    <div class="media-body mt-1">
                                        <h4>Jennifer</h4>
                                ...
                                <li class="ms-list-item media">
                                    <img src="/images/doctor-3.jpg" class="ms-img-small ms-img-round" alt="people">
                                    <div class="media-body mt-1">
                                        <h4>Adwerd </h4>
                                ...
                                <li class="ms-list-item media">
                                    <img src="/images/doctor-4.jpg" class="ms-img-small ms-img-round" alt="people">
                                    <div class="media-body mt-1">
                                        <h4>John Doe</h4>
                                ...
                                <li class="ms-list-item media">
                                    <img src="/images/doctor-5.jpg" class="ms-img-small ms-img-round" alt="people">
                                    <div class="media-body mt-1">
                                        <h4>Jordan</h4>
                    ...
                    <div class="ms-panel ms-panel-fh ms-facebook-engagements">
                        ...
                        <div class="ms-panel-body p-0">
                            <div class="ms-facebook-page-selection">
                                ...
                                <div class="dropdown">
                                    <a href="#" class="has-chevron" data-bs-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">Doctor Name here</a>
                        ...
                        <div class="ms-panel-body">
                            <div class="table-responsive">
                                <table class="table table-hover  thead-primary">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="ms-table-f-w"> <img src="/images/patient-3.jpg" alt="people">
                                                Richard </td>
                                        ...
                                        <tr>
                                            <td class="ms-table-f-w"> <img src="/images/patient-2.jpg" alt="people">
                                                William </td>
                                        ...
                                        <tr>
                                            <td class="ms-table-f-w"> <img src="/images/patient-4.jpg" alt="people">
                                                John Doe </td>
                                        ...
                                        <tr>
                                            <td class="ms-table-f-w"> <img src="/images/patient-5.jpg" alt="people">
                                                Martin </td>
                                        ...
                                        <tr>
                                            <td class="ms-table-f-w"> <img src="/images/patient-1.jpg" alt="people">
                                                Robert </td>
